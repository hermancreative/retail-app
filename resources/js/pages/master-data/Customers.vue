...
import CustomerController from '@/actions/App/Http/Controllers/MasterData/CustomerController';
...
const formBinding = computed(() =>
    editing.value
        ? CustomerController.update.form(editing.value.id)
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                min="0"
                                name="credit_limit"
                                :default-value="editing?.credit_limit ?? 0"
                            />
                        </div>
                        <div class="grid gap-2">
                            <Label for="credit_terms_days"
                            ...
                            <Input
                                ...
                                :default-value="editing?.credit_terms_days ?? 0"
                            />
                        </div>
                    </div>
